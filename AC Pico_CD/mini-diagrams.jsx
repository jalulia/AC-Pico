...
const Diagrams = {
  ...
  '07': () => (
    <g>
      <text x="220" y="22" className="lbl-sm fill-only" stroke="none" textAnchor="middle" style={{ fontSize: 9 }}>Q1–Q10 — LOW-SIDE N-MOSFET SINK</text>
  ...
  '08': () => (
    <g>
      <text x="220" y="22" className="lbl-sm fill-only" stroke="none" textAnchor="middle" style={{ fontSize: 9 }}>J_LED_OUT — 10 LED / LAMP TERMINALS</text>
      {/* terminal strip */}
      <rect x="40" y="50" width="360" height="36" className="ink" strokeWidth="1.25" />
      <line x1="40" y1="66" x2="400" y2="66" className="ink hair" />
      {Array.from({ length: 10 }).map((_, i) => {
        const cx = 60 + i * 36;
        return (
          <g key={i}>
            <line x1={cx} y1="66" x2={cx} y2="78" className="ink hair" />
            <circle cx={cx} cy="80" r="3" fill="var(--gold)" />
            <text x={cx} y="62" className="lbl-sm fill-only" stroke="none" textAnchor="middle" style={{ fontSize: 8 }}>OUT{i}</text>
          </g>
        );
      })}
      {/* wiring example */}
      <g transform="translate(80 120)" className="ink hair">
        <text x="0" y="0" className="lbl-sm fill-only" stroke="none" style={{ fontSize: 8 }}>WIRING — ONE BUTTON LED</text>
        {/* VLED+ */}
        <line x1="0" y1="20" x2="280" y2="20" />
        <text x="-4" y="24" className="lbl-sm fill-only" stroke="none" textAnchor="end" style={{ fontSize: 8 }}>VLED+</text>
        {/* LED */}
        <line x1="140" y1="20" x2="140" y2="36" />
        <polygon points="134,36 146,36 140,52" className="ink-fill fill-only" stroke="none" />
        <line x1="134" y1="52" x2="146" y2="52" />
        <line x1="140" y1="52" x2="140" y2="72" />
        <text x="150" y="46" className="lbl-sm fill-only" stroke="none" style={{ fontSize: 7 }}>BUTTON LED</text>
        {/* OUTx box */}
        <rect x="120" y="72" width="40" height="14" />
        <text x="140" y="82" className="lbl-sm fill-only" stroke="none" textAnchor="middle" style={{ fontSize: 8 }}>OUTx</text>
      </g>
    </g>
  ),
  ...
  '11': () => (
    <g>
      <text x="220" y="22" className="lbl-sm fill-only" stroke="none" textAnchor="middle" style={{ fontSize: 9 }}>POWER &amp; DECOUPLING — 3V3 LOGIC DOMAIN</text>
      {/* USB → Pico regulator → 3.3V rail */}
      <g transform="translate(40 60)" className="ink" strokeWidth="1.25">
        {/* USB 5V */}
        <text x="0" y="0" className="lbl-sm fill-only" stroke="none" style={{ fontSize: 8 }}>USB 5V</text>
        <line x1="0" y1="8" x2="32" y2="8" />
        {/* regulator box */}
        <rect x="32" y="-4" width="60" height="24" />
        <text x="62" y="11" className="lbl-sm fill-only" stroke="none" textAnchor="middle" style={{ fontSize: 7 }}>RT6150 LDO</text>
        <line x1="92" y1="8" x2="140" y2="8" />
        <text x="148" y="11" className="lbl-sm fill-only" stroke="none" style={{ fontSize: 8 }}>3V3 RAIL</text>
        {/* GND */}
        <line x1="0" y1="40" x2="320" y2="40" />
        <text x="324" y="44" className="lbl-sm fill-only" stroke="none" style={{ fontSize: 8 }}>GND</text>
      </g>
      {/* decoupling caps */}
      <g transform="translate(120 110)" className="ink hair">
        <text x="0" y="0" className="lbl-sm fill-only" stroke="none" style={{ fontSize: 8 }}>DECOUPLING — 100nF PER IC + BULK</text>
        {[0, 1, 2, 3, 4].map(i => (
          <g key={i} transform={`translate(${i * 48} 14)`}>
            <line x1="0" y1="0" x2="0" y2="6" />
            <line x1="-6" y1="6" x2="6" y2="6" />
            <line x1="-6" y1="10" x2="6" y2="10" />
            <line x1="0" y1="10" x2="0" y2="16" />
            <text x="0" y="28" className="lbl-sm fill-only" stroke="none" textAnchor="middle" style={{ fontSize: 7 }}>0.1µF</text>
          </g>
        ))}
      </g>
      <text x="220" y="180" className="lbl-sm fill-only" stroke="none" textAnchor="middle" style={{ fontSize: 8, fill: 'var(--ink-faint)' }}>
        Star-point near J_LED_POWER · ADC AVDD filtered separately
      </text>
    </g>
  )
};
